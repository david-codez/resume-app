...
import hangmanImage from '../../public/images/hangman-screenshot.png'
...
export default function Pokedex() {
  ...
  const iconSize = '4rem'
    ...
    return (
        <div>
        <h1 className='page-header'>Hangman</h1>
        <Image src={hangmanImage} alt='To Do List' height='300' width='500' />
        <Link href={hangmanUrl}><a><h2>Click Here For Project</h2></a></Link>
        <hr />
